# AUROUAV System Architecture

## 1. Overview

AUROUAV is a modular autonomy stack for UAVs, designed around ROS2, PX4, and GPU‑accelerated perception. The system is decomposed into:
