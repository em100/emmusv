...
🚀 Overview
AUROUAV is a modular autonomy stack for UAVs, integrating:
...
AUROUAV integrates transformer‑based perception, visual‑inertial SLAM,
...
📦 Installation
bash
mkdir -p musvtech_ws/src
cd musvtech_ws/src
git clone https://github.com/em100/musvtech systems.git
cd ..
